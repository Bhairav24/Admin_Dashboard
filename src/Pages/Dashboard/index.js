...
Dashboard
    ...
    title={'Orders'} value={orders}/>
      ...
      <DashboardCard icon={<ShoppingOutlined  style={{color:'blue',
    ...
    padding:8
      ...
      <DashboardCard icon={<UserOutlined  style={{color:'purple',
    ...
    padding:8
      ...
      <DashboardCard icon={<DollarCircleFilled  style={{color:'red',
